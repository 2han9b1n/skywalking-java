...
public class PreparedStatementInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String KYLIN_PREPARED_STATEMENT_CLASS = "dm.jdbc.driver.DmdbPreparedStatement";
    private static final String PREPARED_STATEMENT_EXECUTE_METHODS_INTERCEPTOR_CLASS = "org.apache.skywalking.apm.plugin.jdbc.dm.PreparedStatementExecuteMethodsInterceptor";
